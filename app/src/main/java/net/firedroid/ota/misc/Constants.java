 ...
 */
package net.firedroid.ota.misc;
...
public final class Constants {
    ...
    static final String PROP_BUILD_VERSION = "net.firedroid.version";
    static final String OTA_URL = "https://raw.githubusercontent.com/firedroid-AOSP/official_devices/%s/API/updater/%s.json";
    static final String MAINTAINER_URL = "https://github.com/%s";
    static final String DOWNLOAD_WEBPAGE_URL = "https://sourceforge.net/projects/project-firedroid/files/%s";
    static final String EXPORT_PATH = "firedroid-Updates/";
}
