 ...
 */
package net.firedroid.ota;

import static net.firedroid.ota.model.UpdateStatus.UNKNOWN;
...
import net.firedroid.ota.ExtrasFragment.UpdateListener;
import net.firedroid.ota.controller.ABUpdateInstaller;
import net.firedroid.ota.controller.UpdaterController;
import net.firedroid.ota.controller.UpdaterService;
import net.firedroid.ota.download.DownloadClient;
import net.firedroid.ota.misc.Constants;
import net.firedroid.ota.misc.Utils;
import net.firedroid.ota.model.UpdateInfo;
import net.firedroid.ota.model.UpdateStatus;
import net.firedroid.ota.model.Update;
